...
Jx=nx(ones(1,sny),:)-snx/2;
Jy=ny(ones(1,snx),:)'-sny/2;
J0=zeros(size(Jx));
J1=ones(size(Jx));
...
switch lower(transform)
    ...
    case 'quadratic'%[1 x y 0 0 0 x^2 xy; 0 0 0 1 x y xy y^2]
        Jx2=Jx.*Jx;Jy2=Jy.*Jy;Jxy=Jx.*Jy;
        
        J = [J1, Jx, Jy, J0, J0, J0, Jx2, Jxy;...
            J0, J0, J0, J1, Jx, Jy, Jxy, Jy2];    
